...
./nginx-ingress/install-nginx-ingress.sh
...
echo ""
echo "Waiting for TLS secret to be created by cert-manager..."
...
echo ""
echo "--> Applying Longhorn Certificate & Ingress..."
...
echo ""
echo "--> Applying Grafana Certificate..."
...
echo ""
echo "--> Applying Prometheus Certificate..."
...
echo ""
echo "--> Applying ArgoCD Certificate & Ingress..."
...
echo ""
echo "--> Applying SonarQube Certificate & Ingress..."
...
echo "$INGRESS_IP dashboard.local longhorn.local grafana.local prometheus.local argocd.local fm-compta-consulting.local sonarqube.local allure.local zap.local" | sudo tee -a /etc/hosts
